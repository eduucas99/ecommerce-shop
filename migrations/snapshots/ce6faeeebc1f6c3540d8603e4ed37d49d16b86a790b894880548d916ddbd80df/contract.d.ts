...
export type StorageHash =
  StorageHashBase<'ce6faeeebc1f6c3540d8603e4ed37d49d16b86a790b894880548d916ddbd80df'>;
...
export namespace Models {
  ...
  export type public_Product = {
    ...
    sizes: public_ProductSize[];
    readonly [RelationKeys]?: 'category' | 'sizes';
  };
  export type public_ProductSize = {
...
export declare const models: {
  public: {
    ...
    ProductSize: Models.public_ProductSize;
  };
};
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly productSize: {
              ...
              primaryKey: { readonly columns: readonly ['productId', 'size'] };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'productSize_productId_idx_5858600a';
                  readonly prefix: 'productSize_productId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'productSize';
                    readonly columns: readonly ['productId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
